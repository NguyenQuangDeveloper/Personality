...
public class CAxtKeCAMCFS20
{
    ...
    */
    ...
    public static extern void CFS20KePresetPulseDrive(short axis,
    ...
    // Continous drive
    [DllImport("AxtLib.dll")]
    public static extern void CFS20KeContinuousDrive(short axis,
                      ushort ulRange, ushort ulSTSPSpeedData, ushort ulObjectSpeedData,
                      ushort ulRate1Data, ushort ulRate2Data, ushort ulRate3Data,
                      ushort ulRCPoint12, ushort ulRCPoint23, MOVE_DIRECTION nDirection);
    // Signal search 1 drive
    [DllImport("AxtLib.dll")]
    public static extern void CFS20KeSignalSearch1Drive(short axis,
                      ushort ulRange, ushort ulSTSPSpeedData, ushort ulObjectSpeedData,
                      ushort ulRate1Data, ushort ulRate2Data, ushort ulRate3Data,
                      ushort ulRCPoint12, ushort ulRCPoint23, MOVE_DIRECTION nDirection);
    // Signal search 2 drive
    [DllImport("AxtLib.dll")]
    public static extern void CFS20KeSignalSearch2Drive(short axis,
                      ushort ulRange, ushort ulSTSPSpeedData, MOVE_DIRECTION nDirection);

    // 2004.03.31 안병건 추가
    [DllImport("AxtLib.dll")]
    public static extern void CFS20KeSensorPositioningDrive(short axis,
                      ushort ulRange, ushort ulSTSPSpeedData, ushort ulObjectSpeedData,
                      ushort ulRate1Data, ushort ulRate2Data, ushort ulRate3Data,
    ...
    // 대칭, 가속율
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeDriveData(short axis, double dStartStop, double dVelocity, double dAcceleration,
    ...
    // 대칭, 가속시간
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeDriveDataEx(short axis, double dStartStop, double dVelocity, double dAccelTime,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRate1, ref ushort pRateChange12);
    // 속도오버라이드(mode=1), 대칭, 가속율
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeSpeedData(byte mode, short axis, double dStartStopSpeed, double dVelocity, double dAcceleration,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRate1, ref ushort pRateChange12);
    // 속도오버라이드(mode=1), 대칭, 가속시간
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeSpeedDataEx(byte mode, short axis, double dStartStopSpeed, double dVelocity, double dAccelTime,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRate1, ref ushort pRateChange12);

    //<+> 2002/12/06 JNS, 비대칭
    // 비대칭, 가속율
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeDriveDataA(short axis, double dStartStop, double dVelocity, double dAcceleration, double dDeceleration,
    ...
    // 비대칭, 가속시간
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeDriveDataAEx(short axis, double dStartStop, double dVelocity, double dAccelTime, double dDecelTime,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRateAccel, ref ushort pRateDecel, ref ushort pRateChange12);
    // 속도오버라이드(mode=1), 비대칭, 가속율
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeSpeedDataA(byte mode, short axis, double dStartStopSpeed, double dVelocity, double dAcceleration, double dDeceleration,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRateAccel, ref ushort pRateDecel, ref ushort pRateChange12);
    // 속도오버라이드(mode=1), 비대칭, 가속시간
    [DllImport("AxtLib.dll")]
    public static extern int CFS20KeGetOptimizeSpeedDataAEx(byte mode, short axis, double dStartStopSpeed, double dVelocity, double dAccelTime, double dDecelTime,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRateAccel, ref ushort pRateDecel, ref ushort pRateChange12);
