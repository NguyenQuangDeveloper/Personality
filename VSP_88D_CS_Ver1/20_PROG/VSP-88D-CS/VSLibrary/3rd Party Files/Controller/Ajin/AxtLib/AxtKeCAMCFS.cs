...
public class CAxtKeCAMCFS
{
    ...
    *------------------------------------------------------------------------------------------------*/
    ...
    public static extern void CFSKePresetPulseDrive(short axis,
    ...
    [DllImport("AxtLib.dll")]
    public static extern void CFSKeContinuousDrive(short axis,
                      ushort ulRange, ushort ulSTSPSpeedData, ushort ulObjectSpeedData,
                      ushort ulRate1Data, ushort ulRate2Data, ushort ulRate3Data,
                      ushort ulRCPoint12, ushort ulRCPoint23, MOVE_DIRECTION nDirection);
    // Signal search 1 drive : 신호 검출-1 구동 
    [DllImport("AxtLib.dll")]
    public static extern void CFSKeSignalSearch1Drive(short axis,
                      ushort ulRange, ushort ulSTSPSpeedData, ushort ulObjectSpeedData,
                      ushort ulRate1Data, ushort ulRate2Data, ushort ulRate3Data,
                      ushort ulRCPoint12, ushort ulRCPoint23, MOVE_DIRECTION nDirection);
    // Signal search 2 drive : 신호 검출-2 구동 
    [DllImport("AxtLib.dll")]
    public static extern void CFSKeSignalSearch2Drive(short axis,
    ...
    // 대칭, 가속율
    [DllImport("AxtLib.dll")]
    public static extern int CFSKeGetOptimizeDriveData(short axis, double dStartStop, double dVelocity, double dAcceleration,
    ...
    // 대칭, 가속시간
    [DllImport("AxtLib.dll")]
    public static extern int CFSKeGetOptimizeDriveDataEx(short axis, double dStartStop, double dVelocity, double dAccelTime,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRate1, ref ushort pRateChange12);
    // 속도오버라이드(mode=1), 대칭, 가속율
    [DllImport("AxtLib.dll")]
    public static extern int CFSKeGetOptimizeSpeedData(byte mode, short axis, double dStartStopSpeed, double dVelocity, double dAcceleration,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRate1, ref ushort pRateChange12);
    // 속도오버라이드(mode=1), 대칭, 가속시간
    [DllImport("AxtLib.dll")]
    public static extern int CFSKeGetOptimizeSpeedDataEx(byte mode, short axis, double dStartStopSpeed, double dVelocity, double dAccelTime,
                      ref ushort pRangeData, ref ushort pStartStopSpeedData, ref ushort pObjectSpeedData, ref ushort pRate1, ref ushort pRateChange12);
}