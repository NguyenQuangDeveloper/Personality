...
namespace VSP_88D_CS.Sequence.Profiles.LoadPusher;

public class SeqLoadingPusher : BaseSequence
{
    public override int ModuleId { get; set; } = (int)eSequenceModule.SeqLoadingPusher;
    public override string LogHead { get; set; } = "LOAD_PUSHER";
    public SeqLoadingPusher()
    {
