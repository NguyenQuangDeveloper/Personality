...
public class SeqLoadElevator : BaseSequence
{
    public override int ModuleId { get; set; } = (int)eSequenceModule.SeqLoadElevator;
    public override string LogHead { get; set; } = "LOAD_ELEV";
    public SeqLoadElevator()
    {
