...
namespace VSP_88D_CS.Sequence.Profiles.Elevators;

public class SeqUnloadElevator : BaseSequence
{
    public override int ModuleId { get; set; } = (int)eSequenceModule.SeqUnloadElevator;
    public override string LogHead { get; set; } = "UNLD_ELEV";
    public SeqUnloadElevator()
    {
