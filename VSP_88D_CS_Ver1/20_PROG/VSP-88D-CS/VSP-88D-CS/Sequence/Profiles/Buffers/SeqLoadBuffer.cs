...
public class SeqLoadBuffer : BaseSequence
{
    private LoadBufferCtrl _ctrl;

    public override int ModuleId { get; set; } = (int)eSequenceModule.SeqLoadBuffer;
    public override string LogHead { get; set; } = "LOAD_BUFFER";
    public SeqLoadBuffer()
    {
