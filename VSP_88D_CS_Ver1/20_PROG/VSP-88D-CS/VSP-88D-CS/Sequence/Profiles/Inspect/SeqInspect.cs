...
namespace VSP_88D_CS.Sequence.Profiles.Inspect;

public class SeqInspect : BaseSequence
{
    public override int ModuleId { get; set; } = (int)eSequenceModule.SeqInspect;
    public override string LogHead { get; set; } = "INSPECT";
    public SeqInspect()
    {
